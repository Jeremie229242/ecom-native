...
type CartContextType = {
    cartItems: CartItem[],
    addToCart:(product: Product,itemId: string, size: string)=> Promise<void>;
...
export function CartProvider({children}: {children: ReactNode}){
    ...
    const removeFromCart = async (product: string, size: string) => {
    ...
    return (
        <CartContext.Provider value={{
            cartItems, addToCart, removeFromCart, updateQuantity, cartTotal, itemCount, isLoading, clearCart
        }}>
            {children}
